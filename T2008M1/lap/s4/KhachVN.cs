...
{
    public class KhachVN : Hoadondien
    {
        string doituong;
        ...
        public KhachVN(int id, string name, string date, string dategetbill, int soluong, string doituong) : base(id, name, date, dategetbill, soluong)
        {
